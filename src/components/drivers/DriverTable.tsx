        ...
        <TableBody>
          {drivers.map((driver) => (
            <TableRow key={driver._id} className="hover:bg-gray-50">
                  ...
                  <Link
                    href={
                      driver.supplierOwner
                        ? `/suppliers/${driver.supplierOwner._id}`
                        : `/drivers/${driver._id}`
                    }
              ...
              {/* License No. */}
              <TableCell className="text-sm text-gray-700">{driver.licenseNumber || '—'}</TableCell>

              {/* PAN */}
              <TableCell className="text-sm text-gray-700">{driver.panNumber || '—'}</TableCell>

              {/* City */}
              <TableCell className="text-sm text-gray-700">{driver.city || '—'}</TableCell>
              ...
              <TableCell className="text-sm text-gray-500">
                {driver.createdAt ? format(new Date(driver.createdAt), 'dd-MMM-yy') : '—'}
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
